  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        <Card className="bg-white/60 dark:bg-slate-800/60 backdrop-blur-sm border shadow-lg">
          <CardHeader>
                    ...
                    {teamDevices.map((device) => (
                      <Button
                        ...
                        className={`w-full justify-start text-left ${
                          selectedDevice === device._id ? 'bg-teal-600 hover:bg-teal-700' : ''
                        }`}
                      ...
                      >
                        <div className="flex items-center justify-between mb-2">
                          ...
                          <Badge
                            ...
                            className={config.status === 'validated' ? 'bg-green-100 text-green-800' : ''}
                          >
                            {config.status}
                          </Badge>
                        </div>
        ...
        <DialogContent className="bg-background max-w-4xl">
          ...
          {selectedConfig && (
            <div className="space-y-6">
              <div className="grid md:grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  <Badge
                    ...
                    className={selectedConfig.status === 'validated' ? 'bg-green-100 text-green-800' : ''}
                  >
              ...
              <div className="flex gap-2">
                <Button
                  onClick={() => handleGenerateReport(selectedConfig._id)}
                  className="bg-teal-600 hover:bg-teal-700"
                >
